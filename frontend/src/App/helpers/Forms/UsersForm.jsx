    ...
    return (
        <Form className="mt-1" autoComplete="of" onSubmit={(e) => { e.preventDefault(); if (!update) { saveData(Array.from(e.target)) } else { updateData(Array.from(e.target)) } }}>
            <Form.Group as={Col}>
                ...
                <Form.Control name="fromInputs" placeholder="Escriba el Nombre" />
            </Form.Group>

            <Form.Group as={Col}>
                <Form.Label>Solapin</Form.Label>
                <Form.Control name="fromInputs" placeholder="Escriba el Solpin" />
            </Form.Group>
            <Form.Group as={Col}>
                <Form.Label>Usuario</Form.Label>
                <Form.Control name="fromInputs" placeholder="Escriba el Usuario" />
            </Form.Group>

            <Form.Group as={Col}>
                <Form.Label>Contraseña</Form.Label>
                <Form.Control name="fromInputs" type="password" placeholder="Escriba la Contraseña" />
            </Form.Group>

            <Form.Group as={Col}>
                <Form.Label>Rol</Form.Label>
                <Form.Control name="fromInputs" as="select" custom defaultValue="">
            ...
            <Col className="text-right">
                ...
                <Button className="ml-3" variant="primary" type="submit"> Aceptar </Button>
            </Col>
        </Form >
    )
}
